...
char* MQTTServer = "210.60.50.178";
int MQTTPort = 1883;//School MQTT Port
char* MQTTUser = "";//不須帳密
char* MQTTPassword = "";//不須帳密
//推播主題1:推播溫度(記得改Topic)
char* MQTTPubTopic1 = "DHT11/test01/temp";
//推播主題2:推播濕度(記得改Topic)
char* MQTTPubTopic2 = "DHT11/test01/humi";
//訂閱主題1:改變LED燈號(記得改Topic)
char* MQTTSubTopic1 = "DHT11/test01/led";
